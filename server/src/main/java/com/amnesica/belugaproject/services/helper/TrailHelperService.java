  ...
  public List<AircraftTrail> checkAircraftTrailsFor180Border(List<AircraftTrail> trails) {
    ...
    for (int i = 0; i < trails.size(); i++) {
      ...
      if (Math.abs(currentTrail.getLongitude() - nextTrail.getLongitude()) > 180) {
        ...
        var tempEndpoint = new AircraftTrail(currentTrail.getHex(), nextTrail.getLongitude(), midY, nextTrail.getAltitude(), true, 0L, null, null);
        var tempStartpoint = new AircraftTrail(currentTrail.getHex(), nextTrail.getLongitude(), midY, nextTrail.getAltitude(), true, 0L, null, null);
  ...
  public List<SpacecraftTrail> checkSpacecraftTrailsFor180Border(List<SpacecraftTrail> trails) {
    ...
    for (int i = 0; i < trails.size(); i++) {
      ...
      if (Math.abs(currentTrail.getLongitude() - nextTrail.getLongitude()) > 180) {
        ...
        var tempEndpoint = new SpacecraftTrail(currentTrail.getHex(), nextTrail.getLongitude(), midY, nextTrail.getAltitude(), false, 0L, null, null);
        var tempStartpoint = new SpacecraftTrail(currentTrail.getHex(), nextTrail.getLongitude(), midY, nextTrail.getAltitude(), false, 0L, null, null);
